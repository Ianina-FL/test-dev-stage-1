    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Human_resources Role</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.human_resources_role &&
                      Array.isArray(users.human_resources_role) &&
                      users.human_resources_role.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!users?.human_resources_role?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
