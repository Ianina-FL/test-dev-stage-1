...
const options = {
  definition: {
    ...
    info: {
      version: '1.0.0',
      title: 'test dev stage 1',
      description:
        'test dev stage 1 Online REST API for Testing and Prototyping application. You can perform all major operations with your entities - create, delete and etc.',
    },
    servers: [
      {
